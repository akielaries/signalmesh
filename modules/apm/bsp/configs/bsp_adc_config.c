...
#endif
static adcsample_t
  internal_samples[ADC_INTERNAL_NUM_CHANNELS * ADC_BUFFER_DEPTH];
...
static const ADCConversionGroup adc_grp_pots_config = {
  ...
  .pcsel =
    ADC_SELMASK_IN10 | ADC_SELMASK_IN13 | ADC_SELMASK_IN15 | ADC_SELMASK_IN5,
  .smpr =
    {
  ...
  .sqr = {ADC_SQR1_SQ1_N(ADC_CHANNEL_IN10) | ADC_SQR1_SQ2_N(ADC_CHANNEL_IN13) |
            ADC_SQR1_SQ3_N(ADC_CHANNEL_IN15) | ADC_SQR1_SQ4_N(ADC_CHANNEL_IN5),
          0,
          0,
          0}};
...
static const ADCConversionGroup adc_grp_internal_config = {
  ...
  .sqr = {ADC_SQR1_SQ1_N(ADC_CHANNEL_IN18) | ADC_SQR1_SQ2_N(ADC_CHANNEL_IN19),
          0,
          0,
          0}};
