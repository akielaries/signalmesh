// proves the external USB-serial link on USART3 (PB10 TX / PB11 RX) at 115200.
// the UART5 debug console (PC12/PD2, 1 Mbaud) is left alone, so boot logs still
// come out there while this heartbeat goes to the dongle on minicom.
