...
#ifndef GOWIN_M1_SPI_H
#define GOWIN_M1_SPI_H
...
#define CLKSEL_CLK_DIV_6   ((uint32_t) 0x00000002)  //CLK/6
#define CLKSEL_CLK_DIV_8   ((uint32_t) 0x00000003)  //CLK/8
