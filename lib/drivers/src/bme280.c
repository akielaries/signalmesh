...
static int bme280_poll(device_id_t device_id, uint32_t num_readings, driver_reading_t *readings);
...
static bool bme280_read_calib_params(bme280_t *bme_dev) {
  ...
  bme_dev->calib_params.dig_H2 = (int16_t)(((int16_t)hum_data[1] << 8) | hum_data[0]);
  bme_dev->calib_params.dig_H3 = hum_data[2];
  bme_dev->calib_params.dig_H4 = (int16_t)(((int16_t)hum_data[3] << 4) | (hum_data[4] & 0x0F));
...
static uint32_t bme280_compensate_humidity_int32(int32_t adc_H, bme280_t *bme_dev) {
  ...
  v_x1_u32r =
    (((((adc_H << 14) - (((int32_t)bme_dev->calib_params.dig_H4) << 20) -
     ...
     (((((((v_x1_u32r * ((int32_t)bme_dev->calib_params.dig_H6)) >> 10) *
          (((v_x1_u32r * ((int32_t)bme_dev->calib_params.dig_H3)) >> 11) + ((int32_t)32768))) >>
         10) +
        ((int32_t)2097152)) *
  ...
  v_x1_u32r =
    (v_x1_u32r -
     (((((v_x1_u32r >> 15) * (v_x1_u32r >> 15)) >> 7) * ((int32_t)bme_dev->calib_params.dig_H1)) >>
      4));
