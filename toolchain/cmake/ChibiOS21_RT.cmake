SET(CHIBIOS_rt_SEARCH_PATH
  ...
  ${CHIBIOS_ROOT}/os/common/ports/ARM-common/include
  ${CHIBIOS_ROOT}/os/common/startup/ARMCMx
  ${CHIBIOS_ROOT}/os/common/startup/ARMCMx/compilers/GCC
  ${CHIBIOS_ROOT}/os/common/ports/ARMv7-M
  ${CHIBIOS_ROOT}/os/common/ports/ARMv7-M/compilers/GCC
  ${CHIBIOS_ROOT}/os/hal/osal/rt-nil
)
...
ELSEIF(STM32_FAMILY STREQUAL "H7")
  ...
  SET(CHIBIOS_rt_PLATFORM_SEARCH_PATH
    ${CHIBIOS_ROOT}/os/common/startup/ARMCMx/devices/STM32H7xx
    ${CHIBIOS_ROOT}/os/common/ext/ARM/CMSIS/Core/Include
    ${CHIBIOS_ROOT}/os/common/ext/ST/STM32H7xx
  )
  SET(CHIBIOS_rt_PLATFORM_SEARCH_HEADERS
    core_cm7.h
    stm32h7xx.h
