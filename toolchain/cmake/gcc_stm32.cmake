...
SET(STM32_SUPPORTED_FAMILIES L0 F0 F1 F2 F3 F4 F7 H7 CACHE INTERNAL "stm32 supported families")
...
IF(NOT STM32_FAMILY)
    ...
    ELSE()
        ...
        STRING(REGEX REPLACE "^[sS][tT][mM]32(([fF][0-47])|([lL][0-14])|([tT])|([wW])|([hH]7)).+$" "\\1" STM32_FAMILY ${STM32_CHIP})
...
#SET(CMAKE_C_COMPILER ${TOOLCHAIN_BIN_DIR}/${TARGET_TRIPLET}-gcc${TOOL_EXECUTABLE_SUFFIX} GNU)
#SET(CMAKE_CXX_COMPILER ${TOOLCHAIN_BIN_DIR}/${TARGET_TRIPLET}-g++${TOOL_EXECUTABLE_SUFFIX} GNU)
...
SET(CMAKE_C_FLAGS_RELEASE "-lm -Os -flto" CACHE INTERNAL "c compiler flags release")
...
#INCLUDE("${CMAKE_CURRENT_LIST_DIR}/../../toolchain/cmake/gcc_stm32${STM32_FAMILY_LOWER}.cmake")
